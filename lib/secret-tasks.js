 ...
 * @param {boolean} options.DeploymentCenter.secret.enabled - Secret center enabled
 * @throws Error
 * @return options
 */
exports.verify = function(options){
	return Q.when(options)
		.then(function(){
			...
			if(!options.DeploymentCenter.secret.enabled)
				throw new Error('Secrets are not enabled for the environment');
